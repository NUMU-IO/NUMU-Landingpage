              ...
              <div className="relative h-[calc(100%-40px)] overflow-hidden">
                ...
                <div className="absolute inset-0 p-3 flex flex-col transition-all duration-500" style={{
                  ...
                  <div className="grid grid-cols-3 gap-1.5 flex-1">
                    {productColors.map((color, idx) => (
                      <div key={idx} className={`${color} rounded-lg relative overflow-hidden aspect-square flex items-center justify-center`}>
                ...
                <div className="absolute inset-0 p-3 flex flex-col transition-all duration-500" style={{
                  ...
                  <div className="flex-1 space-y-2 overflow-hidden">
                    {productNames.slice(0, 6).map((product, idx) => (
                      <div key={idx} className="flex items-center gap-2 p-2 bg-gray-50 rounded-lg transition-all duration-500" style={{
                        opacity: activeStep === 1 ? 1 : 0,
                ...
                <div className="absolute inset-0 p-3 flex flex-col transition-all duration-500" style={{
                  ...
                  <div className="grid grid-cols-2 gap-2 flex-1 overflow-hidden">
                    {productNames.slice(0, 6).map((product, idx) => (
                      <div key={idx} className="bg-gray-50 rounded-xl overflow-hidden flex flex-col transition-all duration-500" style={{
                        opacity: activeStep === 2 ? 1 : 0,
                  ...
                  <div className="mt-3 bg-green-50 border border-green-200 rounded-xl p-2 flex items-center justify-center gap-1.5" style={{
                    opacity: activeStep === 2 ? 1 : 0,
