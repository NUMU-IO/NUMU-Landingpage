    ...
    <div className="max-w-6xl mx-auto w-full px-4 sm:px-6 py-8">
      <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
        ...
        <div className="lg:w-1/2 text-center lg:text-start">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-background-alt shadow-card mb-6 w-fit mx-auto lg:mx-0">
              ...
              <div className="relative h-[calc(100%-40px)] overflow-hidden">
                ...
                <div className="absolute inset-0 p-3 flex flex-col transition-all duration-500" style={{
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-3">
                    <div className="bg-background-alt rounded-2xl p-2 text-center shadow-card">
                    ...
                    <div className="bg-background-alt rounded-2xl p-2 text-center shadow-card">
                      <p className="text-lg font-bold text-text-main">4</p>
                      <p className="text-[8px] text-text-muted font-medium">{dir === 'rtl' ? 'قنوات فعالة' : 'Active Channels'}</p>
                    </div>
                  </div>
                  <div className="space-y-2 flex-1">
                    {channels.map((ch, idx) => (
                      <div key={idx} className="flex items-center gap-2.5 p-2.5 bg-background-alt rounded-2xl shadow-card transition-all duration-500" style={{
                        opacity: activeStep === 0 ? 1 : 0,
                ...
                <div className="absolute inset-0 p-3 flex flex-col transition-all duration-500" style={{
                  ...
                  <div className="flex items-center gap-2 bg-background-alt rounded-2xl p-2 mb-3 shadow-card">
                  ...
                  <div className="mt-3">
                    <div className="bg-navy text-white text-xs font-bold py-2.5 rounded-2xl text-center flex items-center justify-center gap-1.5 shadow-card">
                ...
                <div className="absolute inset-0 p-3 flex flex-col transition-all duration-500" style={{
                  ...
                  <div className="bg-background-alt rounded-2xl p-3 mb-3 shadow-card transition-all duration-500" style={{
                    opacity: activeStep === 2 ? 1 : 0,
                    ...
                    <p className="text-xl font-bold text-text-main">{dir === 'rtl' ? '١٢٨,٤٠٠ ج.م' : 'EGP 128,400'}</p>
                  ...
                  <div className="space-y-2 flex-1">
                    {channels.map((ch, idx) => {
                      ...
                      return (
                        <div key={idx} className="bg-background-alt rounded-2xl p-2.5 shadow-card transition-all duration-500" style={{
                          opacity: activeStep === 2 ? 1 : 0,
                          transform: activeStep === 2 ? 'translateY(0)' : 'translateY(10px)',
                          ...
                          <div className="h-1.5 bg-background-light rounded-full overflow-hidden bg-paper border border-ink/10">
                  ...
                  <div className="mt-3 bg-background-alt shadow-card rounded-2xl p-2 flex items-center justify-center gap-1.5" style={{
                    opacity: activeStep === 2 ? 1 : 0,
              ...
              {steps.map((_, idx) => (
                <button
                  ...
                  className={`rounded-full transition-all duration-300 ${
                    activeStep === idx ? 'w-8 h-2.5 bg-navy shadow-card' : 'size-2.5 bg-background-alt shadow-card hover:bg-paper border border-ink/10'
                  }`}
                />
              ))}
            </div>
