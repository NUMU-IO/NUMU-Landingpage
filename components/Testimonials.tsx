    ...
    <div className="max-w-6xl mx-auto w-full px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
        {testimonials.map((t, i) => (
          <article key={i} className="rounded-2xl sm:rounded-3xl shadow-neu-pressed p-5 sm:p-6 md:p-8 bg-background-light">
            ...
            <blockquote className="text-sm text-text-muted italic">{t.text}</blockquote>
          </article>
        ))}
      </div>
    </div>
