...
const sections: { title: string; text: string; accent: 'navy' | 'saffron' | 'sage' | 'terracotta' }[] = [
  ...
  { title: 'terms.content_title', text: 'terms.content_text', accent: 'terracotta' },
  { title: 'terms.termination_title', text: 'terms.termination_text', accent: 'navy' },
  { title: 'terms.liability_title', text: 'terms.liability_text', accent: 'saffron' },
  { title: 'terms.contact_title', text: 'terms.contact_text', accent: 'sage' },
];
...
const Terms: React.FC = () => {
  ...
  useSEO({
    title: isAr ? 'شروط الاستخدام — نُمُو' : 'Terms of service — numu',
    description: isAr
      ? 'الشروط اللي بتحكم استخدام نُمُو — منصة التجارة الإلكترونية عربي الأول لمصر والشرق الأوسط.'
      : 'The terms governing use of numu — the Arabic-first commerce platform for Egypt and MENA.',
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 pt-12 sm:pt-16 pb-10">
        <div className="inline-flex items-center gap-2 bg-saffron/15 border border-saffron/40 rounded-[4px] px-3 py-1 mb-5">
          ...
          <span className="font-mono text-[10px] font-semibold text-saffron uppercase tracking-[0.18em]">
            § TERMS · {t('terms.last_updated')}: {isAr ? 'مارس ٢٠٢٦' : 'March 2026'}
          </span>
        </div>
