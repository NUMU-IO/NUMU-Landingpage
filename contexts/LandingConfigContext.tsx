...
const DEFAULT_CONFIG: LandingConfig = {
  sections: {
    ...
    'how-it-works': { visible: true, order: 1 },
    preview: { visible: true, order: 2 },
    features: { visible: true, order: 3 },
    'trust-network': { visible: true, order: 4 },
    showcase: { visible: true, order: 5 },
    integrations: { visible: true, order: 6 },
    comparison: { visible: true, order: 7 },
    objections: { visible: true, order: 8 },
    savings: { visible: true, order: 9 },
    pricing: { visible: true, order: 10 },
    testimonials: { visible: true, order: 11 },
    'founders-100': { visible: true, order: 12 },
    faq: { visible: true, order: 13 },
    cta: { visible: true, order: 14 },
    contact: { visible: true, order: 15 },
    footer: { visible: true, order: 16 },
  },
};
